...
//    public float resource;
 ...
 //   public Quaternion modelRotation;
  ...
  //  public Quaternion baseLocalRotation;
    ...
    public bool AddChild(Vector3 position, float in_radius, float minDistanceCoef = 1.0f )
    {
   ...
   //     child.resource = 0.0f;
    ...
    public void CalcRotation()
    {
        ...
        else
        {
            ...
            Quaternion fromToRot = Quaternion.FromToRotation(vecFrom, vecTo);
            Vector3 fromToRotEuler = fromToRot.eulerAngles;// Quaternion.ToEulerAngles(fromToRot);
            Vector3 parentEuler = parent.modelRotation.eulerAngles;// Quaternion.ToEulerAngles(parent.modelRotation);

//            modelRotation = parent.modelRotation * Quaternion.FromToRotation(vecFrom, vecTo);
            modelRotation = Quaternion.FromToRotation(vecFrom, vecTo) * parent.modelRotation;

            Vector3 euler = modelRotation.eulerAngles;// Quaternion.ToEulerAngles(modelRotation);
